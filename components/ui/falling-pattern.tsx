...
export function FallingPattern({
  ...
  const dotColor = color.startsWith("var(")
    ? color
    : color.replace(/rgba\(([^,]+),([^,]+),([^,]+),[^)]+\)/, "rgba($1,$2,$3,0.16)");
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `radial-gradient(circle at 50% 50%, ${dotColor} 0, ${dotColor} 1.2px, transparent 1.8px)`,
